...
const getFeedHtml = () => {
    const feedHtml = tweetsData.reduce((acc, tweet) => {
        let repliesHtml = "";
        tweet.replies.length && tweet.replies.forEach(reply => repliesHtml += `
                <div class="tweet-reply">
                    <div class="tweet-inner">
                    <img src=${reply === null || reply === void 0 ? void 0 : reply.profilePic} class="profile-pic">
                        <div>
                            <p class="handle">${reply === null || reply === void 0 ? void 0 : reply.handle}</p>
                            <p class="tweet-text">${reply === null || reply === void 0 ? void 0 : reply.tweetText}</p>
                        </div>
                    </div>
                </div>
            `);
...
const handleRepliesClick = (id) => {
    var _a;
    (_a = document.getElementById(`replies-${id}`)) === null || _a === void 0 ? void 0 : _a.classList.toggle("hidden");
};
